...
export interface EpisodeDetailOverviewComponentProps
...
export const EpisodeDetailOverviewComponent = ({
  entity,
  id,
  name,
  overview,
  ...
  showFavoriteAction,
  showShareAction,
}: EpisodeDetailOverviewComponentProps) => {
  return (
...
const styles = StyleSheet.create({
  ...
  thumbnail: {
    width: Assets.Dimensions.ImageSize.THUMBNAIL_LARGE,
    aspectRatio: 16 / 9,
  },
  actionIconContainer: {
